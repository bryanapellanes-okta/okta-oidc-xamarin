...
namespace Okta.Xamarin
{
	...
	public class AndroidOidcClient : OidcClient
	{
		...
		public AndroidOidcClient(Context context, IOktaConfig oktaConfig) : this(context, oktaConfig, null)
		{

		}

		public AndroidOidcClient(Context context, IOktaConfig oktaConfig, OktaConfigValidator<IOktaConfig> oktaConfigValidator = null) : base(oktaConfig, oktaConfigValidator)
		{
		...
		/// </summary>
		protected Context AndroidContext { get; set; }
